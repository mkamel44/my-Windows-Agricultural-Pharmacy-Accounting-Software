namespace بذرة_أمل
{
    partial class Form12
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.Column2.HeaderText = "اسم الزبون";
        	...
        	this.button1.Text = "اضافة الزبون";
        	...
        	this.button2.Text = "تعديل الزبون";
