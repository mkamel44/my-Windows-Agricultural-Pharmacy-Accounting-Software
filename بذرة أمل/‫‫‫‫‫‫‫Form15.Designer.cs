namespace بذرة_أمل
{
    partial class Form15
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.dataGridView2.MouseClick += new System.Windows.Forms.MouseEventHandler(this.DataGridView2MouseClick);
        	// 
        	// Column1
        	// 
        	...
        	this.Text = "دفعات فاتورة المبيعات";
